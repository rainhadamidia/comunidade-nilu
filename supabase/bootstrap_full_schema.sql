-- ============================================
-- BOOTSTRAP COMPLETO DO BANCO — projeto Supabase novo
-- ============================================
-- Junta, em ordem, todas as migrations de supabase/migrations/ para
-- recriar o schema inteiro num projeto Supabase vazio (usado na
-- migração de hospedagem do Lovable para Vercel + Supabase próprio).
-- Rodar uma única vez, do início ao fim, no SQL Editor do projeto novo.
